...
const tokenizeSentences = (text) => text.match(/[^.!?]+[.!?]*\s*/g) || [];
...
export const computeChildEqualityFactor = (_node1, _node2) => 0;
...
export const createDiffNode = (schema, node, type) =>
  mapDocumentNode(node, (currentNode) => {
